...
class WeekData
{
	...
	public static function reloadWeekFiles(isStoryMode:Null<Bool> = false, dir:String = 'main')
	{
		weeksList = [];
		weeksLoaded.clear();
		#if MODS_ALLOWED
		...
		var sexList:Array<String> = CoolUtil.coolTextFile(Paths.getPreloadPath('weeks/' + dir + '/weekList.txt'));
		for (i in 0...sexList.length)
		{
			for (j in 0...directories.length)
			{
				var fileToCheck:String = directories[j] + 'weeks/' + dir + '/' + sexList[i] + '.json';
		...
		{
			var directory:String = directories[i] + 'weeks/' + dir + '/';
