...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Obligatory Plug",	"Visit my website.",						'shameless_plug',	 true],
		["NANI?!",		"Play \"Death\" via the debug menu.",				'nani',			true],
		["The Wrist Game!!",				"Beat 8Bit on Hard with no Misses.",				'8bit_nomiss',			false],
		["Shift Key? More like Shit Key!",			"Beat Shift Key on Hard with no Misses.",				'shift_nomiss',			false],
		["Ron Ripoff",					"Beat Foldery on Hard with no Misses.",				'foldery_nomiss',			false],
		["B-Sides But Better",			"Beat any Erect Remix with no Misses.",			'erect_nomiss',			true],
