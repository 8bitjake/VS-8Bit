...
class CustomFadeTransition extends MusicBeatSubstate {
	...
	var isCoolZoom:Bool = false;
	var coolZoomMax:Int = 10;
	...
	public function new(duration:Float, isTransIn:Bool) {
		...
		if(isTransIn) {
			...
			if(isCoolZoom == false) FlxG.camera.zoom = coolZoomMax; isCoolZoom = true;
			...
			ease: FlxEase.linear});
			isCoolZoom = false;
			FlxTween.tween(FlxG.camera, {zoom: coolZoomMax}, duration+0.1, {
				onComplete:null,
